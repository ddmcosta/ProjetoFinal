...
public class tela_servicos extends JFrame {
	...
	public tela_servicos() {
		...
		JCheckBox box_formatacao = new JCheckBox("Formatação R$:120,00");
		...
		JCheckBox box_troca_de_tela = new JCheckBox("Troca de Tela R$180,00");
